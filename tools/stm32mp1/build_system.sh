...
#rm -r out
#make clean
make CFG_TEE_CORE_LOG_LEVEL=3 CROSS_COMPILE=arm-linux-gnueabihf- CROSS_COMPILE_core=arm-linux-gnueabihf- CROSS_COMPILE_ta_arm32=arm-linux-gnueabihf- -j $BUILDCORES PLATFORM=stm32mp1-${sBoard}
...
BL33_CFG=../u-boot/u-boot.dtb STM32MP_SDMMC=1 all

## Create FIP
echo "Start Building FIP"
make ARM_ARCH_MAJOR=7 ARCH=aarch32 PLAT=stm32mp1 AARCH32_SP=optee LOG_LEVEL=50 CROSS_COMPILE=arm-none-eabi- -j$BUILDCORES \
BL32=../optee_os/out/arm-plat-stm32mp1/core/tee.elf \
